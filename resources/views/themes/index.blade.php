    ...
    <div class="container-xxl bg-primary hero-header">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-start">
                    <img class="{{ asset('assets') }}/img-fluid animated zoomIn" src="{{ asset('assets') }}/img/hero.png"
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                    <img class="{{ asset('assets') }}/img-fluid" src="{{ asset('assets') }}/img/about.png">
                </div>
        ...
        <div class="container px-lg-5">
            <div class="row align-items-center" style="height: 250px;">
                ...
                <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                    <img class="{{ asset('assets') }}/img-fluid mt-5" style="max-height: 250px;"
    ...
    <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="owl-carousel client-carousel">
                <a href="#"><img class="{{ asset('assets') }}/img-fluid" src="{{ asset('assets') }}/img/logo-1.png"
                        alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid" src="{{ asset('assets') }}/img/logo-2.png"
                        alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-3.png" alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-4.png" alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-5.png" alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-6.png" alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-7.png" alt=""></a>
                <a href="#"><img class="{{ asset('assets') }}/img-fluid"
                        src="{{ asset('assets') }}/img/logo-8.png" alt=""></a>
            </div>
        </div>
    </div>
    <!-- Client End -->
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item rounded p-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="{{ asset('assets') }}/img-fluid flex-shrink-0 rounded-circle"
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <img class="{{ asset('assets') }}/img-fluid rounded-circle w-100 mb-4"
