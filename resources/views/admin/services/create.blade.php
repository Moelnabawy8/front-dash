        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h5 page-title m-0">{{ __('keywords.Add_New_Service') }}</h2>
                        ...
                        <form action="{{ route('admin.services.store') }}" method="POST">
                            ...
                            <div class="mb-3 col-lg-8 mx-auto">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    ...
                                    placeholder="{{ __('keywords.Enter_service_title') }}">
                                <x-validationcomponent field="title" />
                            </div>
                            <div class="mb-3">
                                <x-labelform field="description" />
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="4" placeholder="{{ __('keywords.Enter_service_description') }}">{{ old('description') }}</textarea>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <x-buttoncomponent text="Add_New_Service" />
                            </div>
                        </form>
                    </div>
                </div>
